...
commodity_url_list = [
    "https://kr.investing.com/indices/japan-ni225"
    , "https://kr.investing.com/indices/vn"
...
for i in range(len(commodity_url_list)):
    ...
    with open(f'{save_data_dir}/{product_name}.csv', 'a', newline='', encoding='utf-8') as csvfile:
        ...
        if csvfile.tell() == 0:
            csv_writer.writerow(['Product', 'Previous Close', 'Open Price', 'Daily Range', '52-Week Range', 'One-Year Return', 'Contract Size'])
